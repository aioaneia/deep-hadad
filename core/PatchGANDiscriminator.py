...
from torch.nn                     import InstanceNorm2d, Sigmoid, Conv2d, ReLU, AdaptiveAvgPool2d, Sequential, ConvTranspose2d, LeakyReLU, Linear, Dropout
...
def build_discriminator(
        base_channels, 
        filter_sizes = [64, 128, 256, 512, 512, 512, 1024, 1024], 
        use_dropout  = False,
        use_se_block = False):
    """
