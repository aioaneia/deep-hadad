...
from torch.nn import InstanceNorm2d, Sigmoid, Conv2d, ReLU, Dropout, Module, Sequential, ConvTranspose2d, LeakyReLU, \
    Linear, ModuleList
        ...
        for idx, filter_size in enumerate(reversed_filter_sized):
            if idx == 0:
                ...
                self.decoders.append(
                    self.deconv_block(filter_size * 2, out_channels, batch_norm=False, activation=Sigmoid()))
            else:
